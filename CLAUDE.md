# CLAUDE.md - Jose's Personal Task Assistant
...
- If ambiguous, pick the most recent one or mention ambiguity in the response (but as this is a JSON strictly, try to pick the best match or return query response explaining ambiguity).
